...
const FAQItem = ({ question, answer }) => /* @__PURE__ */ jsxs("details", { className: "group p-4 rounded-lg bg-gray-800 border border-gray-700 cursor-pointer transition-all duration-200 open:bg-gray-800/80 open:ring-1 open:ring-yellow-500/50", children: [
  /* @__PURE__ */ jsxs("summary", { className: "font-bold text-white text-lg list-none flex justify-between items-center", children: [
    question,
    /* @__PURE__ */ jsx("span", { className: "ml-2 text-yellow-500 group-open:rotate-180 transition-transform", children: "▼" })
  ] }),
  /* @__PURE__ */ jsx("p", { className: "mt-3 text-gray-300 leading-relaxed pl-2 border-l-2 border-yellow-500", children: answer })
] });
const FAQ = () => {
  const faqs = [
    {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto py-12 px-4", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-white mb-8 text-center", children: "Frequently Asked Questions" }),
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: faqs.map((faq, index) => (
      // key is passed here, which resolves the error
      /* @__PURE__ */ jsx(FAQItem, { question: faq.question, answer: faq.answer }, index)
    )) })
  ] });
};
export {
